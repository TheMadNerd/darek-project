				...
				setArticle(
					articles.map(article => (
						...
						<div className="col-lg-3 flex-column d-flex align-items-stretch">
							...
							<NavLink className="lift lift-lg shadow-light-lg card h-100 card-spacer-y: 5px" key={article.id}  to={`/article/${article.id}`} onClick={() => navLinkHandler(article.id)}  style={{ textDecoration: 'none', width: '18rem'}}>
								...
								<img
									...
									<svg viewBox="0 0 2100 480" fill="none" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" clipRule="evenodd" d="M2160 0C1440 240 720 240 720 240H0v240h2880V0h-720z" fill="currentColor"></path></svg>                  </div>
									</div>
								...
								<div className="card-body d-flex flex-column">
									...
									<p className="card-text" style={{whiteSpace: 'nowrap',overflow: 'hidden',overflowWrap: 'break-word',textOverflow: 'ellipsis',width: '250px', color: '#869ab8'}}>{article.summary}</p>
								...
								<div className='card-meta mt-auto'>
									...
									<p className="h6 text-uppercase text-muted mb-0 ms-auto">{format(parseISO(article.publishedAt), "dd MMMM")}</p>
								</div>
