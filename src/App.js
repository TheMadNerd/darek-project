...
function App() {
						...
						<div className="col-lg-3 flex-column d-flex align-items-stretch">
							<div className="card h-100 card-spacer-y: 5px" key={article.id} style={{ width: '18rem' }}>
								...
								<div className="card-body d-flex flex-column">
									...
									<button type="button" className="btn btn-warning mt-auto">
										<NavLink to={`/article/${article.id}`} id={article.id} onClick={navLinkHandler}>
											MORE
										</NavLink>
									</button>
								</div>
	...
	const navBar = (
		<nav
			class=" navbar-collapse text-center  justify-content-center bg-body-tertiary fixed-top"
			style={{ padding: '10px' }}>
			<form class="container-fluid justify-content-start ">
				<button class="btn btn-sm btn-outline-secondary" type="button" value="5" onClick={buttonHandler}>
					5
				</button>
				<button class="btn btn-sm btn-outline-secondary" type="button" value="15" onClick={buttonHandler}>
					15
				</button>
				<button class="btn btn-sm btn-outline-secondary" type="button" value="30" onClick={buttonHandler}>
					30
				</button>
			</form>
		</nav>
